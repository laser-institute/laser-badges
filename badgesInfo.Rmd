...
This badge is earned for completing the LASER orientation learning lab covering the concepts of open science and reproducible research for application to learning analytics using R, R Studio, and GitHub Desktop.
...
This badge is earned for completing the first Foundations learning lab on the types of data typically used to perform learning analytics in education. 

### 2. The Learning Analytics Workflow

![](badges/foundations/FLA_LAWorkflow_Hx.png){width="145px"}

This badge is earned for completing the second Foundations learning lab on the Learning Analytics workflow.
...
This badge is earned for completing the third Foundations learning lab on the basic principles of data visualization as it relates to data graphics, including data visualization perception and color.

### 4. Data Products

![](badges/foundations/FLA_DataProducts_Hx.png){width="145px"}

This badge is earned for completing the fourth Foundations learning lab on the essentials of crafting a data product for different stakeholders.
